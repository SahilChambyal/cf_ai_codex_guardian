/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 9b10f245750a6cf3e75ed8ae46424080)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	CodexAgent: DurableObjectNamespace /* CodexAgent */;
	REVIEW_WORKFLOW: Workflow /* ReviewWorkflow */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CodexAgent";
	}
